...
<div class="row">
<div class="col-sm-8">
<h1 class="mainTitle"><font face="Garamond" size="6px" >Staff | Manage Patients</font></h1>
</div>
<ol class="breadcrumb">
<li>
<span>Staff</span>
...
<p align="center">                            
 <button class="btn btn-primary waves-effect waves-light w-lg" data-toggle="modal" data-target="#myModal">Add Test History</button></p>  
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
     <div class="modal-content">
      <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Add Test History</h5>
  ...
  <tr>
    ...
    <th>Test details :</th>
    <td>
    <textarea name="test_details" placeholder="Test details" rows="9" cols="14" class="form-control wd-450" required="true"></textarea></td>
  </tr>  
    <tr>
    <th>Test results:</th>
    <td>
    <textarea name="test_results" placeholder="Test results" rows="4" cols="7" class="form-control wd-450" required="true"></textarea></td>
  </tr>  
