...
<div class="row">
<div class="col-sm-8">
	<?php $sql=mysqli_query($con,"select * from staff where id='".$_SESSION['id']."'");
$data=mysqli_fetch_array($sql);
	?>
<h1 class="mainTitle"><font face="Garamond" size="6px" ><?php echo $data['staffRole'];?> | Manage Patients</font></h1>
</div>
<ol class="breadcrumb">
<li>
<span>Doctor</span>
