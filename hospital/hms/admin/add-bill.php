...
<html lang="en">
	<head>
		<title>Admin | Add Hospital Bill</title>
				...
				<div class="main-content" >
					<div class="wrap-content container" id="container">
						...
						<section id="page-title">
							<div class="row">
								<div class="col-sm-8">
									<h1 class="mainTitle"><font face="Garamond" size="6px" >Admin |  Add Hospital Bill</font></h1>
																	</div>
								<ol class="breadcrumb">
									<li>
										<span>Admin</span>
...
<div class="form-group">
					...
					<input type="text" name="Surgical_Appliances" class="form-control"  placeholder="Surgical_Appliances" required="true">
														</div>
